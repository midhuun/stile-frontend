...
const Categories = () => {
  ...
  return (
    ...
    <div className=' flex flex-col min-w-[140px] md:min-w-[350px] sm:w-[32%] justify-center gap-1 md:gap-4' key={category._id}>
        <Link to={`/subcategory/${category.slug}`}><img loading="lazy" className='rounded-md h-[230px] xs:h-[300px] w-full md:h-[450px]  object-top object-cover ' src={`${category.image}?w=400&h=500&q=75`} alt="" /></Link>
