...
const OtpLoginPopup = () => {
  ...
  async function onOTPVerify(e: any) {
    ...
    try {
      ...
      //   const res = await fetch('https://stile-backendd.vercel.app/verify-otp',{method:'POST',headers:{
      ...
      if (res.success) {
        ...
        const data = await fetch('https://stile-backendd.vercel.app/user/login', {
          method: 'POST',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
  ...
  async function onSignup(e) {
    ...
    try {
      ...
      // const res = await fetch("https://stile-backendd.vercel.app/send-otp", {
      //     method: "POST",
      //     headers: {
      //         "Content-Type": "application/json",
      //     },
  ...
  async function otpVerified(e) {
    ...
    const res = await fetch('https://stile-backendd.vercel.app/user/login', {
      method: 'POST',
