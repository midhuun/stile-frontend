      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-xs md:text-sm">
            Redefining fashion with premium quality and unique styles. Your go-to destination for
            modern and stylish clothing.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            <a
              ...
              className="p-2 bg-blue-500 rounded-full hover:bg-gray-500"
            >
              <FaFacebookF />
            </a>
            <a
              href="https://www.instagram.com/stilesagio"
              className="p-2 bg-red-500 rounded-full hover:bg-gray-500"
            >
              <FaInstagram />
            </a>
            <a
              href="https://www.youtube.com/@Stilesagio"
              className="p-2 bg-white text-red-500 rounded-full hover:bg-gray-500"
            >
              <FaYoutube />
            </a>
            <a
              href="https://maps.app.goo.gl/gsi1unahDiVUFr6z9"
              className="p-2 bg-white text-blue-600 rounded-full hover:bg-gray-500"
            >
              <MdLocationPin />
            </a>
            <a
              href="tel:+918220856333"
              className="p-2 bg-white text-blue-600 rounded-full hover:bg-gray-500"
            >
              <PiPhoneCall />
            </a>
