...
const CustomizeOrder = () => {
  return (
    <div className="container mx-auto px-6 py-12">
      <SEO
        title="Custom T-Shirts & Apparel Manufacturing | Stile Sagio - Low MOQ, Premium Quality"
        description="Custom t-shirt manufacturing with low MOQ starting from 50 pieces. Premium cotton, professional printing, embroidery & screen printing. Get custom t-shirts, polo shirts, and apparel made in India."
        keywords={[
          'custom t shirts',
        ...
        structuredData={[
          {
            ...
            "description": "Custom t-shirt and apparel manufacturing with low MOQ starting from 50 pieces",
            "provider": {
              "@type": "Organization",
              "name": "Stile Sagio",
            ...
            "offers": {
              "@type": "Offer",
              "priceCurrency": "INR",
              "description": "Custom t-shirt manufacturing with low minimum order quantity"
            }
          },
          {
            "@context": "https://schema.org",
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Customize",
                "item": "https://stilesagio.com/customize"
              }
            ]
          }
        ]}
